...
articleView.handleAuthorFilter = function() {
  $('#author-filter').on('change', function() {
    ...
    if ($(this).val()) {
      ...
      // the ones that match for the author that was selected.
...
articleView.handleMainNav = function() {
  ...
  // Clicking any .tab element should hide all the .tab-content sections, and thsole.log();en reveal the single .tab-content section that is associated with the clicked .tab element.
